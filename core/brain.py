...
class OllamaBrain:
    ...
    def _send_request(self, prompt):
        ...
        system_context = (
            ...
            "- 'cria pasta' -> mkdir\n\n"
            "- considere como 'home' o /home/{nome do usário que você tem acesso} ou simplemente use o atalho ~ para se referir a esta pasta. Exemplo: 'abra a pasta de downloads' -> 'nemo ~/Downloads'\n"
